...
export default function SettingsPage() {
  ...
  // Profile state - use authenticated user data
  const [profile, setProfile] = useState({
    name: user?.name || "Levo",
    email: user?.email || "tokyo9900777@gmail.com",
    company: "MorxCorp",
    role: user?.role || "Founder",
    bio: "Founder and visionary behind Morx, a cutting-edge SaaS platform revolutionizing workflow management and team collaboration. Passionate about building scalable solutions that empower teams to achieve more through data-driven insights and seamless integration. Dedicated to creating innovative tools that transform how organizations operate in the digital age.",
    location: "Alexandria - Egypt",
    website: "www.MorxLLC.io",
    timezone: "UTC"
  })
