          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-8 text-center">
              ...
              <div className="relative w-full">
                ...
                <div className="flex animate-scroll gap-16 hover:pause-animation">
                  {/* First set of logos */}
                  <div className="flex gap-16 items-center shrink-0">
                    ...
                    />
                    <Image
                      src="https://www.chameleon-nu.tech/images/1212-removebg-preview.png"
                      alt="ChameleonFCDS"
                      width={120}
                      height={40}
                    ...
                    />
                    <Image
                      src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/We_logo.svg/768px-We_logo.svg.png"
                      alt="WE (Telecom Egypt)"
                      width={80}
                      height={40}
                      className="h-10 w-auto opacity-70 hover:opacity-100 transition-opacity"
                      unoptimized
