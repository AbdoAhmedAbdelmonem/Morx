...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = () => {
    ...
    console.log("Sign in with Google - Coming soon")
  }

  const handleGithubSignIn = () => {
    // Commented out for now
    // TODO: Implement GitHub OAuth
    console.log("Sign in with GitHub - Coming soon")
  }
      ...
      <AuthTransition mode="signin">
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="text-sm text-muted-foreground text-center">
            Use <span className="font-mono font-semibold">admin</span> / <span className="font-mono font-semibold">admin123</span> to sign in
          </div>
          {/* <div className="text-sm text-muted-foreground text-center">
